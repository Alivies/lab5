...
namespace lab5 {
    ...
    public class Corrector {
        ...
        private List<string> AddMisspelled(List<string> Misspelled) {
            string Word;
            Console.WriteLine("Добавляйте вариации. Введите 0, чтобы остановить.");
        ...
        private void AddWord() {
            ...
            if (Dictionary.ContainsKey(NewWord)) {
                throw new Exception("Слово уже добавлено.");
            }
        ...
        public void Program() {
            ...
            while (true) {
                ...
                if (File.Exists(Name)) {
                    ...
                    Console.WriteLine("\n Файл не найден. Пробовать снова. \n");
                }
            }
            ...
            while (true) {
                Console.Clear();
                Console.WriteLine("Добавить новую дирректорию     0");
                Console.WriteLine("Изменить текст                 1");
                Console.WriteLine("Изменить номер                 2");
